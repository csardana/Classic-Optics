    ...
    <div class="col-sm-7">
        <div class="card shadow my-3">
            <div class="card-body">
                ...
                <h5>Latest Review : <strong class="text-danger">${p.review}</strong></h5>
                <c:choose>
                <c:when test="${sessionScope.userid ne null }">
                <form method="post" action="/addtocart/Review/${p.prodid}">
                    
                    Review : <input name="review">       
                    <br>
                    <div class="btn-group mt-3">
                        <button class="btn btn-danger mr-2" name="add">Save Review</button>                                        
                    </div>
                </form>
                <form method="post">
