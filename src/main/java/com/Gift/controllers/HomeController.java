...
public class HomeController {
	...
	@PostMapping("addtocart/Review/{prodid}")
	public String saveReviewtoProduct(Model model,@PathVariable("prodid") int productid,String review) {
		
		String userid=session.getAttribute("userid").toString();
		prodsrv.saveProduct(prodsrv.findProductById(productid),review);
